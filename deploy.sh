...
aws lambda --region us-east-1 update-function-configuration --function-name download-surrealdb-com --runtime nodejs20.x --handler index.main --timeout 5 --memory-size 128 && sleep 3
